...
class DiffusionModel(nn.Module):
    def __init__(self, network: nn.Module, max_steps: int, min_beta: float, max_beta: float):
        ...
        :param network: The backbone of the DDPM model.
        :param max_steps: The maximum number of denoising steps.
        :param min_beta: The minimum beta value.
    ...
    @torch.no_grad()
    def sample_new_images(self, num_samples:int = 64, image_shape:Tuple[int, int, int] = (1, 32, 32), clip_embedding: Optional[torch.Tensor]=None) -> torch.Tensor:
        """
...
class ConditionalUNet(nn.Module):
    def __init__(self, in_channels:int=1, time_embedding_dim:int=128, clip_embedding_dim:int=64):
        """
        Defines the U-Net architecture that can be conditioned on time- and clip-embedding.
        :param in_channels: The number of input channels.
        :param time_embedding_dim: The dimension of the time embedding.
        :param clip_embedding_dim: The dimension of the clip embedding.
        """
...
class TimeEmbedding(nn.Module):
    def __init__(self, embedding_dim:int) -> None:
        """
        Implements the sinusoidal time embedding.
...
class ConvolutionBlock(nn.Module):
    def __init__(self, in_channels:int, out_channels:int, time_emb_dim:int, clip_dim:int, kernel_size:int=3, stride:int=1, padding:int=1, num_groups:int=2):
        """
        Defines the convolutional block used at each level of the U-Net.
        :param in_channels: The number of input channels.
        :param out_channels: The number of output channels.
        :param time_emb_dim: The dimension of the time embedding.
        :param clip_dim: The dimension of the time embedding.
        :param kernel_size: The size of the convolution kernel.
        :param stride: The stride of the convolution kernel.
        :param padding: The padding of the convolution kernel.
